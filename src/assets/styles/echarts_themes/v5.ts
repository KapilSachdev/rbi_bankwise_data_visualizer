export const v5 = {
  ...
  treemap: {
    left: 'center', top: 'middle', width: '80%', height: '80%', scaleLimit: { max: null, min: null },
    breadcrumb: {
  ...
  dataZoom: {
    borderColor: '#d2dbee', borderRadius: 3, backgroundColor: 'rgba(47,69,84,0)',
  ...
  legend: {
    top: 0, bottom: null, backgroundColor: 'rgba(0,0,0,0)', borderColor: '#ccc', itemGap: 10, inactiveColor: '#ccc', inactiveBorderColor: '#ccc',
    lineStyle: { inactiveColor: '#ccc' }, textStyle: { color: '#333' }, selectorLabel: { color: '#666', borderColor: '#666' },
    emphasis: { selectorLabel: { color: '#eee', backgroundColor: '#666' } }, pageIconColor: '#2f4554', pageIconInactiveColor: '#aaa', pageTextStyle: { color: '#333' }
  },
  radar: {
  ...
  timeline: {
    padding: 5, borderColor: '#ccc', lineStyle: { color: '#DAE1F5' }, label: { color: '#A4B1D7' }, itemStyle: { color: '#A4B1D7', borderWidth: 1 },
    checkpointStyle: { color: '#316bf3', borderColor: '#fff', borderWidth: 2, shadowBlur: 2, shadowOffsetX: 1, shadowOffsetY: 1, shadowColor: 'rgba(0, 0, 0, 0.3)' },
    controlStyle: {
      ...
      color: '#A4B1D7', borderColor: '#A4B1D7', borderWidth: 1
    },
    emphasis: {
      label: { color: '#6f778d' },
  ...
  title: {
    ...
    textStyle: { color: '#464646' }, subtextStyle: { color: '#6E7079' }
  },
  toolbox: {
    borderColor: '#ccc', padding: 5, itemGap: 8, iconStyle: { borderColor: '#666' },
    emphasis: { iconStyle: { borderColor: '#3E98C5' } }
  },
  tooltip: {
    axisPointer: { crossStyle: { color: '#999' } },
    textStyle: { color: '#666' }, backgroundColor: '#fff', borderWidth: 1, defaultBorderColor: '#fff'
  },
  visualMap: {
    color: ['#bf444c', '#d88273', '#f6efa6'],
    inactive: ['rgba(0,0,0,0)'],
    indicatorStyle: { shadowColor: 'rgba(0,0,0,0.2)' },
    backgroundColor: 'rgba(0,0,0,0)', borderColor: '#ccc', contentColor: '#5793f3', inactiveColor: '#aaa', padding: 5,
    textStyle: { color: '#333' }
  }
};
